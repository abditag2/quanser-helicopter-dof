...
// -6.5	-0.801	-75.7161 -7.0
// -6.5 0.6701	-75.7529 10.0

	U.u1 = -6.5 * (x.elevation-sp.elevation) - .801 * x.pitch  - 200.7161 * PERIOD * x.d_elevation -20.0 * PERIOD * x.d_pitch ; //-0.0333*cs->int_elevation -0.001*cs->int_pitch;
	U.u2 = -6.5 * (x.elevation-sp.elevation) + .6701 * x.pitch - 200.7529 * PERIOD * x.d_elevation +24.00 * PERIOD*  x.d_pitch; //-0.03*cs->int_elevation +0.001*cs->int_pitch;
